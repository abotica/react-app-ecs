...
function OrganizationsModal({ setShowOrganizationsModal, handleDataRefresh }) {
    ...
    return (
        <ModalLayout handleCloseModal={handleCloseModal}>
            {isSubmitting ? <ModalAffirmationScreen error={error} success={success} isLoading={isLoading} /> : <OrganizationsModalForm isLoading={isLoading} workshops={workshops} organization={organization} setOrganization={setOrganization} setIsSubmitting={setIsSubmitting} handlePost={handlePost} />}
        </ModalLayout>
    )
}
